...
You can do a lot of HTML things in Markdown (.md) files with similar syntax, but for most of them I'd just use HTML, e.g. to make these words <strong>bold</strong>.
